...
public class Compound_in extends AppCompatActivity {
    ...
    private ArrayList<Question> ciquestionList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_compound_in);
        ...
        if (savedInstanceState == null) {
            ...
            ComoundDbHelper dbHelper = new ComoundDbHelper(this);
            ciquestionList = dbHelper.getAllQuestions();
            question_total = ciquestionList.size();
            Collections.shuffle(ciquestionList);
            showNextQuestion();
        }else {
            ciquestionList = savedInstanceState.getParcelableArrayList(KEY_QUESTION_LIST);
            question_total = ciquestionList.size();
            question_counter = savedInstanceState.getInt(KEY_QUESTION_COUNT);
            currentQuestion = ciquestionList.get(question_counter - 1);
            ...
            public void onClick(View v) {
                if (!answered){
                    if (op1.isChecked() || op2.isChecked() || op3.isChecked() || op4.isChecked()){
                        ...
                        Toast.makeText(Compound_in.this, "Please select an answer", Toast.LENGTH_SHORT).show();
    ...
    private void showNextQuestion(){
        ...
        if (question_counter < question_total){
            currentQuestion = ciquestionList.get(question_counter);
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putParcelableArrayList(KEY_QUESTION_LIST,ciquestionList);
    }
}
