...
public class Time extends AppCompatActivity {
    ...
    private ArrayList<Question> timequestionList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            timequestionList = dbHelper.getAllQuestions();
            question_total = timequestionList.size();
            Collections.shuffle(timequestionList);
            showNextQuestion();
        }else {
            timequestionList = savedInstanceState.getParcelableArrayList(KEY_QUESTION_LIST);
            question_total = timequestionList.size();
            question_counter = savedInstanceState.getInt(KEY_QUESTION_COUNT);
            currentQuestion = timequestionList.get(question_counter - 1);
            ...
            public void onClick(View v) {
                if (!answered){
                    if (op1.isChecked() || op2.isChecked() || op3.isChecked() || op4.isChecked()){
                        ...
                        Toast.makeText(Time.this, "Please select an answer", Toast.LENGTH_SHORT).show();
    ...
    private void showNextQuestion(){
        ...
        if (question_counter < question_total){
            currentQuestion = timequestionList.get(question_counter);
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putParcelableArrayList(KEY_QUESTION_LIST,timequestionList);
    }
}
