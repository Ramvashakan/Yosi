...
public class Probability extends AppCompatActivity {
    ...
    private ArrayList<Question> proquestionList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.probability);
        ...
        if (savedInstanceState == null) {
            ...
            ProDbhelper dbHelper = new ProDbhelper(this);
            proquestionList = dbHelper.getAllQuestions();
            question_total = proquestionList.size();
            Collections.shuffle(proquestionList);
            showNextQuestion();
        }else {
            proquestionList = savedInstanceState.getParcelableArrayList(KEY_QUESTION_LIST);
            question_total = proquestionList.size();
            question_counter = savedInstanceState.getInt(KEY_QUESTION_COUNT);
            currentQuestion = proquestionList.get(question_counter - 1);
            ...
            public void onClick(View v) {
                if (!answered){
                    if (op1.isChecked() || op2.isChecked() || op3.isChecked() || op4.isChecked()){
                        ...
                        Toast.makeText(Probability.this, "Please select an answer", Toast.LENGTH_SHORT).show();
    ...
    private void showNextQuestion(){
        ...
        if (question_counter < question_total){
            currentQuestion = proquestionList.get(question_counter);
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putParcelableArrayList(KEY_QUESTION_LIST,proquestionList);
